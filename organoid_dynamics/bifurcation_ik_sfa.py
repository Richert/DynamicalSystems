...
ode = ODESystem(eq_file="sfa_equations", working_dir="../organoid_dynamics/config", auto_dir=auto_dir, init_cont=False)
...
fig, ax = plt.subplots(figsize=(12, 4))
ode.plot_continuation("PAR(9)", "PAR(5)", cont=f"{p1}/eta:lp1", ax=ax, bifurcation_legend=True)
ode.plot_continuation("PAR(9)", "PAR(5)", cont=f"{p1}/eta:hb1", ax=ax, bifurcation_legend=True,
                      line_color_stable="green")
ode.plot_continuation("PAR(9)", "PAR(5)", cont=f"{p1}/eta:hb2", ax=ax, bifurcation_legend=True,
                      line_color_stable="green")
