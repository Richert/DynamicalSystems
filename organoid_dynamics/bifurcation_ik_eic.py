...
# exc parameters
exc_params = {
    'C': 100.0, 'k': 0.7, 'v_r': -60.0, 'v_t': -40.0, 'Delta': 0.5, 'eta': 0.0, 'kappa': 0.0, 'tau_u': 500.0,
    'g_e': 15.0, 'g_i': 0.0, 'tau_s': 6.0
}

# inh parameters
inh_params = {
    'C': 100.0, 'k': 0.7, 'v_r': -60.0, 'v_t': -40.0, 'Delta': 1.0, 'eta': 0.0,
    'g_e': 10.0, 'g_i': 10.0, 'tau_s': 20.0
}
...
ode = ODESystem(eq_file="eic_equations", working_dir="../organoid_dynamics/config", auto_dir=auto_dir, init_cont=False)
