...
# exc parameters
exc_params = {
    'C': 100.0, 'k': 0.7, 'v_r': -60.0, 'v_t': -40.0, 'Delta': 1.0, 'eta': 0.0, 'kappa': 2000.0, 'tau_u': 500.0,
    'g_e': 100.0, 'g_i': 0.0, 'tau_s': 6.0
}

# inh parameters
inh_params = {
    'C': 100.0, 'k': 0.7, 'v_r': -60.0, 'v_t': -40.0, 'Delta': 1.0, 'eta': 40.0,
    'g_e': 50.0, 'g_i': 0.0, 'tau_s': 10.0
}
