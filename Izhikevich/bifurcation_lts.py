...
t_sols, t_cont = a.run(e='lts', c='ivp', name='t', DS=1e-4, DSMIN=1e-10, EPSL=1e-06, NPR=1000,
...
a.run(starting_point='LP1', c='qif_lc', ICP=[6, 16], name='D/I:lc1', origin=f'I:{target+1}:lc', NMX=8000, DSMAX=0.1,
      NPR=10, RL1=10.0, RL0=0.001, bidirectional=True, ILP=0)
