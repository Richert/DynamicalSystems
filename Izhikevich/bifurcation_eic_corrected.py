...
a.run(starting_point='HB1', c='qif2', ICP=[30, 36], NPAR=n_params, NDIM=n_dim, name='D_fs/I_fs:hb1', origin=c4_cont,
      ...
      EPSS=1e-04)
a.run(starting_point='LP1', c='qif_lc', ICP=[30, 36, 11], NPAR=n_params, NDIM=n_dim, name='D_fs/I_fs:lc1', origin=c6_cont,
      NMX=4000, DSMAX=0.05, UZR={}, STOP=['BP1'], NPR=10, RL1=10.0, RL0=-0.2, bidirectional=True, EPSL=1e-06,
      EPSU=1e-06, EPSS=1e-04)
a.run(starting_point='LP2', c='qif_lc', ICP=[30, 36, 11], NPAR=n_params, NDIM=n_dim, name='D_fs/I_fs:lc2', origin=c6_cont,
      NMX=4000, DSMAX=0.05, UZR={}, STOP=['BP1'], NPR=10, RL1=10.0, RL0=-0.2, bidirectional=True, EPSL=1e-06,
      EPSU=1e-06, EPSS=1e-04)
...
fname = '../results/eic_corrected0.pkl'
kwargs = {'deltas': vals}
