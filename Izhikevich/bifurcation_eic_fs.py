...
c1_sols, c1_cont = a.run(starting_point='UZ1', c='qif', ICP=18, NPAR=n_params, NDIM=n_dim, name='I_rs:1',
                         origin=t_cont, NMX=8000, DSMAX=0.1, UZR={18: [45.0]}, STOP=[f'UZ1'], NPR=100,
                         RL1=100.0, RL0=0.0)
...
c4_sols, c4_cont = a.run(starting_point='HB1', c='qif2b', ICP=[36, 11], NPAR=n_params, NDIM=n_dim, name='I_ib:1:lc1',
                         origin=c3_cont, NMX=8000, DSMAX=0.1, UZR={}, STOP=['LP6', 'BP1'], NPR=20, RL1=200.0)
# a.run(starting_point='HB2', c='qif2b', ICP=[36, 11], NPAR=n_params, NDIM=n_dim, name='I_ib:1:lc2',
#       origin=c3_cont, NMX=8000, DSMAX=0.1, UZR={}, STOP=['LP4', 'BP1'], NPR=20, RL1=200.0)

# continuation in background input to GPe for Delta_ib = 1.5
...
# a.run(starting_point='HB2', c='qif2', ICP=[30, 36], NPAR=n_params, NDIM=n_dim, name='D_ib/I_ib:hb2', origin=c3_cont,
#       NMX=8000, DSMAX=0.1, UZR={}, STOP=[], NPR=10, RL1=10.0, RL0=0.0, bidirectional=True)
...
a.run(starting_point='LP1', c='qif2', ICP=[42, 36], NPAR=n_params, NDIM=n_dim, name='w/I_ib:lp1', origin=c3_cont,
      NMX=8000, DSMAX=0.1, UZR={}, STOP=['CP2'], NPR=10, RL1=50.0, RL0=1.0, bidirectional=True)
a.run(starting_point='LP2', c='qif2', ICP=[42, 36], NPAR=n_params, NDIM=n_dim, name='w/I_ib:lp2', origin=c3_cont,
      NMX=8000, DSMAX=0.1, UZR={}, STOP=['CP2'], NPR=10, RL1=50.0, RL0=1.0, bidirectional=True)

a.run(starting_point='LP1', c='qif2', ICP=[43, 36], NPAR=n_params, NDIM=n_dim, name='w_rs/I_ib:lp1', origin=c3_cont,
      NMX=8000, DSMAX=0.1, UZR={}, STOP=['CP2'], NPR=10, RL1=5.0, RL0=0.1, bidirectional=True)
a.run(starting_point='LP2', c='qif2', ICP=[43, 36], NPAR=n_params, NDIM=n_dim, name='w_rs/I_ib:lp2', origin=c3_cont,
      NMX=8000, DSMAX=0.1, UZR={}, STOP=['CP2'], NPR=10, RL1=5.0, RL0=0.1, bidirectional=True)

a.run(starting_point='LP1', c='qif2', ICP=[44, 36], NPAR=n_params, NDIM=n_dim, name='w_fs/I_ib:lp1', origin=c3_cont,
      NMX=8000, DSMAX=0.1, UZR={}, STOP=['CP2'], NPR=10, RL1=5.0, RL0=0.1, bidirectional=True)
a.run(starting_point='LP2', c='qif2', ICP=[44, 36], NPAR=n_params, NDIM=n_dim, name='w_fs/I_ib:lp2', origin=c3_cont,
      NMX=8000, DSMAX=0.1, UZR={}, STOP=['CP2'], NPR=10, RL1=5.0, RL0=0.1, bidirectional=True)

# save results
##############

fname = '../results/eic_fs.pkl'
kwargs = {'deltas': vals}
