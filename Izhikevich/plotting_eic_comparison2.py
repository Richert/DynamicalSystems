...
fig = plt.figure(1)
grid = gridspec.GridSpec(nrows=6, ncols=6, figure=fig)
...
# continuation in uncorrected model for v_p = 1000
ax = fig.add_subplot(grid[:2, :2])
ax.scatter(rnn_bfs['lp1'][::n_points, 0], rnn_bfs['lp1'][::n_points, 1], c='#5D6D7E', marker=marker, s=s, alpha=alpha)
ax.scatter(rnn_bfs['lp2'][::n_points, 0], rnn_bfs['lp2'][::n_points, 1], c='#5D6D7E', marker=marker, s=s, alpha=alpha)
...
# continuation in corrected model for v_p = 1000
...
# continuation in corrected model for v_p = 100
ax = fig.add_subplot(grid[:2, 2:4])
ax.scatter(rnn2_bfs['lp1'][::n_points, 0], rnn2_bfs['lp1'][::n_points, 1], c='#5D6D7E', marker=marker, s=s, alpha=alpha)
ax.scatter(rnn2_bfs['lp2'][::n_points, 0], rnn2_bfs['lp2'][::n_points, 1], c='#5D6D7E', marker=marker, s=s, alpha=alpha)
...
# continuation in uncorrected model for v_p = 100
ax = fig.add_subplot(grid[2:4, 2:4])
ax.scatter(rnn2_bfs['lp1'][::n_points, 0], rnn2_bfs['lp1'][::n_points, 1], c='#5D6D7E', marker=marker, s=s, alpha=alpha)
ax.scatter(rnn2_bfs['lp2'][::n_points, 0], rnn2_bfs['lp2'][::n_points, 1], c='#5D6D7E', marker=marker, s=s, alpha=alpha)
ax.scatter(rnn2_bfs['hb1'][::n_points, 0], rnn2_bfs['hb1'][::n_points, 1], c='#148F77', marker=marker, s=s, alpha=alpha)
ax.scatter(rnn2_bfs['hb2'][::n_points, 0], rnn2_bfs['hb2'][::n_points, 1], c='#148F77', marker=marker, s=s, alpha=alpha)
...
# continuation in corrected model for v_p = 40
ax = fig.add_subplot(grid[:2, 4:6])
ax.scatter(rnn3_bfs['lp1'][::n_points, 0], rnn3_bfs['lp1'][::n_points, 1], c='#5D6D7E', marker=marker, s=s, alpha=alpha)
ax.scatter(rnn3_bfs['lp2'][::n_points, 0], rnn3_bfs['lp2'][::n_points, 1], c='#5D6D7E', marker=marker, s=s, alpha=alpha)
...
# continuation in uncorrected model for v_p = 40
ax = fig.add_subplot(grid[2:4, 4:6])
ax.scatter(rnn3_bfs['lp1'][::n_points, 0], rnn3_bfs['lp1'][::n_points, 1], c='#5D6D7E', marker=marker, s=s, alpha=alpha)
ax.scatter(rnn3_bfs['lp2'][::n_points, 0], rnn3_bfs['lp2'][::n_points, 1], c='#5D6D7E', marker=marker, s=s, alpha=alpha)
ax.scatter(rnn3_bfs['hb1'][::n_points, 0], rnn3_bfs['hb1'][::n_points, 1], c='#148F77', marker=marker, s=s, alpha=alpha)
ax.scatter(rnn3_bfs['hb2'][::n_points, 0], rnn3_bfs['hb2'][::n_points, 1], c='#148F77', marker=marker, s=s, alpha=alpha)
...
# saving/plotting
fig.canvas.draw()
plt.savefig(f'results/eic_comparison2.pdf')
plt.show()
