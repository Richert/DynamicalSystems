...
a1 = PyAuto.from_file(f"results/eic_corrected2.pkl", auto_dir=auto_dir)
...
ax.scatter(rnn3_bfs['lp1'][::n_points, 0], rnn3_bfs['lp1'][::n_points, 1], c='#5D6D7E', marker='x', s=10, alpha=0.5)
ax.scatter(rnn3_bfs['lp2'][::n_points, 0], rnn3_bfs['lp2'][::n_points, 1], c='#5D6D7E', marker='x', s=10, alpha=0.5)
ax.scatter(rnn3_bfs['hb1'][::n_points, 0], rnn3_bfs['hb1'][::n_points, 1], c='#148F77', marker='x', s=10, alpha=0.5)
ax.scatter(rnn3_bfs['hb2'][::n_points, 0], rnn3_bfs['hb2'][::n_points, 1], c='#148F77', marker='x', s=10, alpha=0.5)
