...
ax.set_title(rf'(C) 1D bifurcation diagram for $\Delta = {deltas[1]}$')
...
# a.plot_continuation('PAR(18)', 'U(1)', cont='I_rs:1:lc2', ax=ax, line_color_stable='#148F77')
# a.plot_continuation('PAR(18)', 'U(1)', cont='I_rs:1:lc3', ax=ax, line_color_stable='#148F77')
ax.set_ylabel(r'$r_{rs}$')
ax.set_title(rf'(B) 1D bifurcation diagram for $\Delta = {deltas[0]}$')
ax.set_xlim([20.0, 80.0])
ax.set_ylim([-0.001, 0.03])
