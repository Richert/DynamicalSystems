...
t_sols, t_cont = a.run(e='izhikevich2_inh', c='ivp', name='t', DS=1e-4, DSMIN=1e-10, EPSL=1e-06, NPR=1000,
...
for i, v in enumerate(vals):
    a.run(starting_point=f'UZ{i+1}', c='qif', ICP=16, NPAR=n_params, NDIM=n_dim, name=f'I:{i+1}', origin=c2_cont,
          NMX=8000, DSMAX=0.1, NPR=10, RL1=200.0)

# continuation of limit cycle
target = 2
a.run(starting_point='HB1', c='qif2b', ICP=16, NPAR=n_params, NDIM=n_dim, name=f'I:{target+1}:lc',
      origin=f'I:{target+1}', NMX=10000, DSMAX=0.2, NPR=10, RL1=200.0, RL0=0.0, STOP=['BP1', 'LP3'])
...
# save results
fname = '../results/izhikevich2_inh.pkl'
