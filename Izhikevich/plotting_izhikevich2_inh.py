...
a = PyAuto.from_file(f"results/izhikevich2_inh.pkl", auto_dir=auto_dir)
...
a.plot_continuation('PAR(16)', 'PAR(6)', cont=f'D/I:hb1', ax=ax, line_color_stable='#5D6D7E',
...
# saving/plotting
fig.canvas.draw()
plt.savefig(f'results/izhikevich2_inh.pdf')
plt.show()
