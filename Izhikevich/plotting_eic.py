...
a.plot_continuation('PAR(36)', 'U(2)', cont='I_ib:1', ax=ax, line_color_stable='#76448A', line_color_unstable='#5D6D7E')
a.plot_continuation('PAR(36)', 'U(2)', cont='I_ib:1:lc', ax=ax, line_color_stable='#148F77')
ax.set_ylabel(r'$v_{ib}$')
...
a.plot_continuation('PAR(36)', 'U(2)', cont='I_ib:2', ax=ax, line_color_stable='#76448A', line_color_unstable='#5D6D7E')
a.plot_continuation('PAR(36)', 'U(2)', cont='I_ib:2:lc', ax=ax, line_color_stable='#148F77')
