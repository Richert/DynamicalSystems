...
# a.plot_continuation('PAR(30)', 'PAR(7)', cont=f'D_ib/D_rs:hb1', ax=ax, line_color_stable='#76448A',
#                     line_color_unstable='#76448A', line_style_unstable='solid')
# a.plot_continuation('PAR(30)', 'PAR(7)', cont=f'D_ib/D_rs:lp1', ax=ax, line_color_stable='#5D6D7E',
#                     line_color_unstable='#5D6D7E', line_style_unstable='solid')
# a.plot_continuation('PAR(30)', 'PAR(7)', cont=f'D_ib/D_rs:lp2', ax=ax, line_color_stable='#5D6D7E',
#                     line_color_unstable='#5D6D7E', line_style_unstable='solid')
# a.plot_continuation('PAR(30)', 'PAR(7)', cont=f'D_ib/D_rs:lc1', ax=ax, line_color_stable='#148F77',
