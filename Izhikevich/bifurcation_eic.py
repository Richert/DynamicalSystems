...
#                          origin=c2_cont, NMX=8000, DSMAX=0.1, UZR={}, STOP=[], NPR=20, RL1=200.0)
# c6_sols, c6_cont = a.run(starting_point='HB3', c='qif2b', ICP=36, NPAR=n_params, NDIM=n_dim, name='I_fs:2:lc1',
#                          origin=c5_cont, NMX=8000, DSMAX=0.1, UZR={}, STOP=['LP3', 'BP1'], NPR=20, RL1=200.0, RL0=0.0)
a.run(starting_point='UZ2', c='qif', ICP=36, NPAR=n_params, NDIM=n_dim, name='I_fs:2',
      origin=c2_cont, NMX=8000, DSMAX=0.1, UZR={}, STOP=[], NPR=20, RL1=200.0)
...
#       NMX=2000, DSMAX=0.2, UZR={}, STOP=['BP1', 'LP2'], NPR=10, RL1=10.0, RL0=0.001, bidirectional=True)
