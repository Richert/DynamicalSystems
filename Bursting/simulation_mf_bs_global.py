...
res = ik.run(simulation_time=T, step_size=dt, sampling_step_size=dts, cutoff=cutoff, solver='euler',
             ...
             inputs={'p/global_recovery_b_op/I_ext': inp}, decorator=nb.njit, fastmath=True, float_precision="float64")

# save results to file
pickle.dump({"results": res, "params": node_vars}, open(f"results/mf_bs_global_{cond}.pkl", "wb"))
