...
r2_sols, r2_cont = a.run(starting_point='UZ2', ICP=8, NPAR=n_params, NDIM=n_dim, name='I_ext:2',
                         origin=c3_cont, UZR={}, STOP=[], RL1=150.0, RL0=-50.0, bidirectional=True)
...
a.run(starting_point='LP2', c='2d', ICP=[5, 8], name='D/I:lp2', origin=r1_cont, RL1=30.0, RL0=0.0, bidirectional=True,
      NPAR=n_params, NDIM=n_dim)
a.run(starting_point='HB1', c='2d', ICP=[5, 8], name='D/I:hb1', origin=r1_cont, RL1=30.0, RL0=0.0, bidirectional=True,
      NPAR=n_params, NDIM=n_dim)
...
r3_sols, r3_cont = a.run(starting_point='UZ1', ICP=8, NPAR=n_params, NDIM=n_dim, name='I_ext:3',
                         origin=c4_cont, UZR={}, STOP=[], RL1=200.0, RL0=-100.0, bidirectional=True)
...
a.run(starting_point='HB1', c='2d', ICP=[5, 8], name='D/I:hb3', origin=r3_cont, RL1=30.0, RL0=0.0, bidirectional=True,
      NPAR=n_params, NDIM=n_dim)
a.run(starting_point='HB1', c='2d', ICP=[5, 8], name='D/I:hb4', origin=r4_cont, RL1=30.0, RL0=0.0, bidirectional=True,
      NPAR=n_params, NDIM=n_dim)
