...
n_dim = 5
n_params = 20
a = ODESystem("etas_test", working_dir="config", auto_dir=auto_dir, init_cont=False)
...
r1_sols, r1_cont = a.run(starting_point='UZ1', ICP=8, name='I_ext:1', origin=c1_cont, UZR={}, STOP=[],
                         RL1=150.0, RL0=0.0)
a.run(starting_point='LP1', c='2d', ICP=[5, 8], name='D/I:lp1', origin=r1_cont, RL1=30.0, RL0=0.0, bidirectional=True,
      NPAR=n_params, NDIM=n_dim)
a.run(starting_point='LP2', c='2d', ICP=[5, 8], name='D/I:lp2', origin=r1_cont, RL1=30.0, RL0=0.0, bidirectional=True,
      NPAR=n_params, NDIM=n_dim)
...
r2_sols, r2_cont = a.run(starting_point='UZ1', ICP=8, name='I_ext:1', origin=c2_cont, UZR={}, STOP=[],
                         RL1=150.0, RL0=0.0)
a.run(starting_point='LP1', c='2d', ICP=[5, 8], name='D/I:lp3', origin=r2_cont, RL1=30.0, RL0=0.0, bidirectional=True,
      NPAR=n_params, NDIM=n_dim)
a.run(starting_point='LP2', c='2d', ICP=[5, 8], name='D/I:lp4', origin=r2_cont, RL1=30.0, RL0=0.0, bidirectional=True,
      NPAR=n_params, NDIM=n_dim)
a.run(starting_point='HB1', c='2d', ICP=[5, 8], name='D/I:hb1', origin=r2_cont, RL1=30.0, RL0=0.0, bidirectional=True,
      NPAR=n_params, NDIM=n_dim)
a.run(starting_point='HB2', c='2d', ICP=[5, 8], name='D/I:hb2', origin=r2_cont, RL1=30.0, RL0=0.0, bidirectional=True,
      NPAR=n_params, NDIM=n_dim)
...
r3_sols, r3_cont = a.run(starting_point='UZ2', ICP=8, NPAR=n_params, NDIM=n_dim, name='I_ext:3',
                         origin=c2_cont, UZR={}, STOP=[], RL1=250.0, RL0=0.0)
a.run(starting_point='HB1', c='2d', ICP=[5, 8], name='D/I:hb3', origin=r3_cont, RL1=30.0, RL0=0.0, bidirectional=True,
      NPAR=n_params, NDIM=n_dim)
a.run(starting_point='HB2', c='2d', ICP=[5, 8], name='D/I:hb4', origin=r3_cont, RL1=30.0, RL0=0.0, bidirectional=True,
      NPAR=n_params, NDIM=n_dim)

# save results
fname = '../results/etas_test.pkl'
