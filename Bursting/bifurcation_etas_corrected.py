...
vals = [5.0, 10.0]
c2_sols, c2_cont = a.run(starting_point='UZ1', ICP=5, name='delta:1', origin=c1_cont, UZR={5: vals},
                         STOP=[f'UZ{len(vals)}'], RL1=11.0, RL0=0.0)
...
a.run(starting_point='LP2', c='2d', ICP=[9, 8], name='b/I:lp4', origin=r2_cont, RL1=RL1, RL0=RL0, bidirectional=True,
      NPAR=n_params, NDIM=n_dim, STOP=STOP)
# a.run(starting_point='HB1', c='2d', ICP=[9, 8], name='b/I:hb1', origin=r2_cont, RL1=RL1, RL0=RL0, bidirectional=True,
#       NPAR=n_params, NDIM=n_dim, STOP=STOP)
# a.run(starting_point='HB2', c='2d', ICP=[9, 8], name='b/I:hb2', origin=r2_cont, RL1=RL1, RL0=RL0, bidirectional=True,
#       NPAR=n_params, NDIM=n_dim, STOP=STOP)
