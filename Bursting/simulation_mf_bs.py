...
# update parameters
ik.update_var(node_vars={'p/recovery_b_op/C': C, 'p/recovery_b_op/k': k, 'p/recovery_b_op/v_r': v_r,
                         'p/recovery_b_op/v_t': v_t, 'p/recovery_b_op/Delta': Delta, 'p/recovery_b_op/kappa': kappa,
                         'p/recovery_b_op/tau_u': tau_u, 'p/recovery_b_op/b': b, 'p/recovery_b_op/tau_s': tau_s,
                         'p/recovery_b_op/g': g, 'p/recovery_b_op/E_r': E_r, 'p/recovery_b_op/tau_x': tau_x,
                         'p/recovery_b_op/eta': eta})
