...
fig, axes = plt.subplots(nrows=2, figsize=(12, 5), layout="constrained")
ax = axes[0]
...
# plotting spikes
neurons = np.random.choice(N, size=100, replace=False)
ax2 = axes[1]
...
fig.canvas.draw()
plt.savefig("/home/richard-gast/Documents/data/dimensionality/figures/spn_dynamics.pdf")
