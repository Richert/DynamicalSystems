...
if any(c3):
    ...
    if c3[1]:
        ...
        c3_b3_hb2_sols, c3_b3_hb2_cont = a.run(starting_point='HB1', c='qif2', ICP=[26, 22], NPAR=n_params,
                                               ...
                                               origin=c3_b3_cont, NMX=4000, DSMAX=0.1, bidirectional=True)
        # c3_b3_hb3_sols, c3_b3_hb3_cont = a.run(starting_point='HB1', c='qif2', ICP=[25, 22], NPAR=n_params,
        #                                        name=f'c3.2:k_gp/k_p_out', NDIM=n_dim, RL0=0.1, RL1=10.0,
        #                                        origin=c3_b3_cont, NMX=4000, DSMAX=0.1, bidirectional=True)
        # c3_b3_hb4_sols, c3_b3_hb4_cont = a.run(starting_point='HB1', c='qif2', ICP=[29, 22], NPAR=n_params,
        #                                        name=f'c3.2:k_gp/k_a_out', NDIM=n_dim, RL0=0.1, RL1=10.0,
        #                                        origin=c3_b3_cont, NMX=4000, DSMAX=0.1, bidirectional=True)
        # c3_b3_hb5_sols, c3_b3_hb5_cont = a.run(starting_point='HB1', c='qif2', ICP=[1, 22], NPAR=n_params,
        #                                        name=f'c3.2:k_gp/eta_e', NDIM=n_dim, RL0=-20.0, RL1=20.0,
        #                                        origin=c3_b3_cont, NMX=4000, DSMAX=0.1, bidirectional=True)
        # c3_b3_hb6_sols, c3_b3_hb6_cont = a.run(starting_point='HB1', c='qif2', ICP=[2, 22], NPAR=n_params,
        #                                        name=f'c3.2:k_gp/eta_p', NDIM=n_dim, RL0=-20, RL1=20.0,
        #                                        origin=c3_b3_cont, NMX=4000, DSMAX=0.1, bidirectional=True)

        # step 3: branch switching to fold curves found tangent to the hopf curves computed in step 2
        c3_b3_zh1_sols, c3_b3_zh1_cont = a.run(starting_point='ZH1', c='qif', ICP=26, NPAR=n_params,
                                               name='c3.2:k_gp_e/zh1', NDIM=n_dim, RL0=0.1, RL1=10.0, NMX=2000, DSMAX=0.5,
                                               origin=c3_b3_hb2_cont, STOP={'BP3'})

        # step 4: continuation of the fold bifurcations found in step 3 in 2 parameters
        c3_b3_zh2_sols, c3_b3_zh2_cont = a.run(starting_point='LP1', c='qif2', ICP=[26, 22], NPAR=n_params,
                                               name='c3.2:k_gp/k_gp_e/zh1', NDIM=n_dim, RL0=0.1, RL1=10.0, NMX=6000,
                                               DSMAX=0.5, origin=c3_b3_zh1_cont, bidirectional=True)

        # step 5: switch onto newly found hopf curve at zero hopf point found in step 4
        k_gp_e = [1.0, 1.25, 1.5, 2.0, 3.0]
        c3_b3_zh3_sols, c3_b3_zh3_cont = a.run(starting_point='ZH6', c='qif', ICP=26, NPAR=n_params,
                                               name='c3.2:k_gp_e/zh2', NDIM=n_dim, RL0=0.1, RL1=10.0, NMX=6000,
                                               DSMAX=0.5, origin=c3_b3_zh2_cont, bidirectional=True, UZR={26: k_gp_e})
        c3_b3_zh4_sols, c3_b3_zh4_cont = a.run(starting_point='ZH3', c='qif', ICP=26, NPAR=n_params,
                                               name='c3.2:k_gp_e/zh2', NDIM=n_dim, RL0=0.1, RL1=10.0, NMX=6000,
                                               DSMAX=0.5, origin=c3_b3_zh2_cont, bidirectional=True)
