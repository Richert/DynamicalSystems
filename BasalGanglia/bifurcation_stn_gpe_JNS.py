...
if c2:
    ...
    c2_b5_sols, c2_b5_cont = a.run(starting_point='UZ1', origin=c2_b4_cont, c='qif', ICP=26, NDIM=n_dim,
                                   NPAR=n_params, RL0=0.0, RL1=3.0, NMX=16000, DSMAX=0.1, name=f'{cond}:k_stn',
                                   UZR={26: [1.5, 3.0]}, bidirectional=True)
    a.run(starting_point='HB1', origin=c2_b5_cont, c='qif2b', ICP=[26, 11], NDIM=n_dim, NPAR=n_params, RL0=0.0,
          RL1=3.0, NMX=4000, DSMAX=0.1, name=f'{cond}:k_stn:lc1')
    a.run(starting_point='HB2', origin=c2_b5_cont, c='qif2b', ICP=[26, 11], NDIM=n_dim, NPAR=n_params, RL0=0.0,
          RL1=3.0, NMX=4000, DSMAX=0.1, name=f'{cond}:k_stn:lc2')
    a.run(starting_point='HB3', origin=c2_b5_cont, c='qif2b', ICP=[26, 11], NDIM=n_dim, NPAR=n_params, RL0=0.0,
          RL1=3.0, NMX=4000, DSMAX=0.1, name=f'{cond}:k_stn:lc3')
    ...
    c2_b6_sols, c2_b6_cont = a.run(starting_point='UZ1', origin=c2_b5_cont, c='qif', ICP=22, NDIM=n_dim,
                                   ...
                                   bidirectional=True)
    a.run(starting_point='HB1', origin=c2_b6_cont, c='qif2b', ICP=[22, 11], NDIM=n_dim, NPAR=n_params, RL0=0.0,
          RL1=20.0, NMX=4000, DSMAX=0.1, name=f'{cond}:k_gp:lc1', STOP=['BP1'])
    a.run(starting_point='HB2', origin=c2_b6_cont, c='qif2b', ICP=[22, 11], NDIM=n_dim, NPAR=n_params, RL0=0.0,
          RL1=20.0, NMX=4000, DSMAX=0.1, name=f'{cond}:k_gp:lc2', STOP=['BP1'])
    ...
    a.run(starting_point='HB1', origin=c2_b7_cont, c='qif2b', ICP=[22, 11], NDIM=n_dim, NPAR=n_params, RL0=0.0,
          RL1=20.0, NMX=4000, DSMAX=0.1, name=f'{cond}:k_gp:2:lc1', STOP=['BP1'])
    a.run(starting_point='HB3', origin=c2_b7_cont, c='qif2b', ICP=[22, 11], NDIM=n_dim, NPAR=n_params, RL0=0.0,
          RL1=20.0, NMX=4000, DSMAX=0.1, name=f'{cond}:k_gp:2:lc2', STOP=['BP1'])
    a.run(starting_point='HB4', origin=c2_b7_cont, c='qif2b', ICP=[22, 11], NDIM=n_dim, NPAR=n_params, RL0=0.0,
          RL1=20.0, NMX=4000, DSMAX=0.1, name=f'{cond}:k_gp:2:lc3', STOP=['BP1'])

    # 2D continuation of k_stn and k_gp
    c2_b5_2d1_sols, c2_b5_2d1_cont = a.run(starting_point='LP1', origin=c2_b5_cont, c='qif2', ICP=[26, 22], NDIM=n_dim,
                                           NPAR=n_params, RL0=0.1, RL1=10.0, NMX=20000, DSMAX=0.1,
                                           name=f'{cond}:k_stn/k_gp:lp1', bidirectional=True)
    c2_b6_2d1_sols, c2_b6_2d1_cont = a.run(starting_point='HB1', origin=c2_b6_cont, c='qif2', ICP=[26, 22], NDIM=n_dim,
                                           NPAR=n_params, RL0=0.1, RL1=10.0, NMX=20000, DSMAX=0.1,
                                           name=f'{cond}:k_stn/k_gp:hb1', bidirectional=True)
    c2_b6_2d2_sols, c2_b6_2d2_cont = a.run(starting_point='HB2', origin=c2_b6_cont, c='qif2', ICP=[26, 22], NDIM=n_dim,
    ...
    c1_b7_sols, c1_b7_cont = a.run(starting_point='UZ1', origin=c1_b5_cont, c='qif', ICP=26, NDIM=n_dim,
                                   NPAR=n_params, RL0=0.1, RL1=5.0, NMX=12000, DSMAX=0.1, name=f'{cond}:k_stn:1',
                                   bidirectional=True, UZR={26: [4.5]})
    a.run(starting_point='HB1', origin=c1_b7_cont, c='qif2b', ICP=[26, 11], NDIM=n_dim, NPAR=n_params, RL0=0.0,
          RL1=5.0, NMX=4000, DSMAX=0.1, name=f'{cond}:k_stn:1:lc1', STOP=['BP1'])
    a.run(starting_point='HB2', origin=c1_b7_cont, c='qif2b', ICP=[26, 11], NDIM=n_dim, NPAR=n_params, RL0=0.0,
          RL1=5.0, NMX=4000, DSMAX=0.1, name=f'{cond}:k_stn:1:lc2', STOP=['BP1'])
    a.run(starting_point='HB3', origin=c1_b7_cont, c='qif2b', ICP=[26, 11], NDIM=n_dim, NPAR=n_params, RL0=0.0,
    ...
    c1_b9_sols, c1_b9_cont = a.run(starting_point='UZ2', origin=c1_b6_cont, c='qif', ICP=26, NDIM=n_dim,
                                   NPAR=n_params, RL0=0.5, RL1=5.0, NMX=12000, DSMAX=0.1, name=f'{cond}:k_stn:3',
                                   bidirectional=True)
    a.run(starting_point='HB1', origin=c1_b9_cont, c='qif2b', ICP=[26, 11], NDIM=n_dim, NPAR=n_params, RL0=0.5,
          RL1=5.0, NMX=4000, DSMAX=0.1, name=f'{cond}:k_stn:3:lc1', STOP=['BP1'])
    a.run(starting_point='HB2', origin=c1_b9_cont, c='qif2b', ICP=[26, 11], NDIM=n_dim, NPAR=n_params, RL0=0.5,
          RL1=5.0, NMX=4000, DSMAX=0.1, name=f'{cond}:k_stn:3:lc2', STOP=['BP1'])
    a.run(starting_point='HB4', origin=c1_b9_cont, c='qif2b', ICP=[26, 11], NDIM=n_dim, NPAR=n_params, RL0=0.5,
          RL1=5.0, NMX=4000, DSMAX=0.1, name=f'{cond}:k_stn:3:lc3', STOP=['BP1'])
    a.run(starting_point='HB5', origin=c1_b9_cont, c='qif2b', ICP=[26, 11], NDIM=n_dim, NPAR=n_params, RL0=0.5,
          RL1=5.0, NMX=4000, DSMAX=0.1, name=f'{cond}:k_stn:3:lc4', STOP=['BP1'])

    # continuation of k_stn for k_gp = 15.0
    c1_b10_sols, c1_b10_cont = a.run(starting_point='UZ3', origin=c1_b6_cont, c='qif', ICP=26, NDIM=n_dim,
                                     NPAR=n_params, RL0=0.0, RL1=5.0, NMX=16000, DSMAX=0.1, name=f'{cond}:k_stn:4',
                                     bidirectional=True)

    # 2D continuation of k_stn and k_gp
    c1_b7_2d1_sols, c1_b7_2d1_cont = a.run(starting_point='LP1', origin=c1_b7_cont, c='qif2', ICP=[26, 22], NDIM=n_dim,
                                           NPAR=n_params, RL0=0.1, RL1=10.0, NMX=20000, DSMAX=0.1,
                                           name=f'{cond}:k_stn/k_gp:lp1', bidirectional=True)
    c1_b7_2d2_sols, c1_b7_2d2_cont = a.run(starting_point='HB1', origin=c1_b7_cont, c='qif2', ICP=[26, 22], NDIM=n_dim,
                                           NPAR=n_params, RL0=0.1, RL1=10.0, NMX=20000, DSMAX=0.1,
                                           name=f'{cond}:k_stn/k_gp:hb1', bidirectional=True)
    c1_b8_2d1_sols, c1_b8_2d1_cont = a.run(starting_point='HB2', origin=c1_b8_cont, c='qif2', ICP=[26, 22], NDIM=n_dim,
                                           NPAR=n_params, RL0=0.1, RL1=10.0, NMX=20000, DSMAX=0.1,
                                           name=f'{cond}:k_stn/k_gp:hb2', bidirectional=True)
    c1_b10_2d1_sols, c1_b10_2d1_cont = a.run(starting_point='HB2', origin=c1_b10_cont, c='qif2', ICP=[26, 22],
