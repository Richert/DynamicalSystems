...
ax = a.plot_continuation('PAR(25)', 'U(2)', cont=f'k_stn:1', ax=ax, default_size=markersize, ignore=['UZ'])
ax = a.plot_continuation('PAR(25)', 'U(2)', cont=f'k_stn:1:lc1', ax=ax, default_size=markersize, ignore=['UZ'],
...
ax = a.plot_continuation('PAR(22)', 'U(2)', cont=f'k_gp:1', ax=ax, default_size=markersize, ignore=['UZ'])
ax = a.plot_continuation('PAR(22)', 'U(2)', cont=f'k_gp:1:lc1', ax=ax, default_size=markersize, ignore=['UZ'],
                         line_color_stable='#148F77', line_color_unstable='#148F77')
...
ax = a.plot_continuation('PAR(22)', 'U(2)', cont=f'k_gp:2', ax=ax, default_size=markersize, ignore=['UZ'])
ax = a.plot_continuation('PAR(22)', 'U(2)', cont=f'k_gp:2:lc1', ax=ax, default_size=markersize, ignore=['UZ'],
                         line_color_stable='#148F77', line_color_unstable='#148F77')
