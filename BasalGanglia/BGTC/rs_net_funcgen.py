...
k_ee = 15.0
k_in = 5.0
W_in = np.random.rand(N, n_in) * k_in
...
# optim = Adadelta(net.parameters(), lr=20.0, rho=0.95, eps=1e-6)
...
for epoch in range(n_epochs):
    ...
    print(f"Epoch #{epoch} finished. Current loss = {losses[0]}")

# get fitted weights
w1 = list(net.parameters())[-1].detach().cpu().numpy()
