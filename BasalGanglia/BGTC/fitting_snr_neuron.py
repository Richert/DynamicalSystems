...
# parameters to train (Atherton and Bevan 2005, Humphries et al. 2006)
C = [40.0, 140.0]
k = [0.1, 10.0]
eta = [0.0, 100.0]
v_r = [-65.0, -45.0]
...
# inputs and target rates (Nakanishi et al. 1987)
inputs = [0.0, 25.0, 50.0, 75.0, 100.0, 125.0, 150.0, 175.0, 200.0]
target_rates = [20.0, 32.0, 42.0, 55.0, 61.0, 67.0, 70.0, 75.0, 80.0]
...
ax.set_title("GPe-p neuron model fit")
ax.legend()
plt.tight_layout()
plt.show()
