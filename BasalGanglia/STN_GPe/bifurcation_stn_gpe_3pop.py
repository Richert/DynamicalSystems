...
a.run(starting_point='HB2', origin=c5_cont, c='qif2b', ICP=[19, 11], NDIM=n_dim, NPAR=n_params, RL0=0.0, RL1=15.0,
      NMX=2000, DSMAX=0.2, name=f'k_gp:1:lc1', STOP=['BP1'], NPR=10)
a.run(starting_point='HB3', origin=c5_cont, c='qif2b', ICP=[19, 11], NDIM=n_dim, NPAR=n_params, RL0=0.0, RL1=15.0,
...
c5_2d2_sols, c5_2d2_cont = a.run(starting_point='HB3', origin=c5_cont, c='qif2', ICP=[5, 19], NDIM=n_dim, NPAR=n_params,
