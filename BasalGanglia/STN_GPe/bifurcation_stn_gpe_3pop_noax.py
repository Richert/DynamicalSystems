...
c4_2d1_sols, c4_2d1_cont = a.run(starting_point='HB1', origin=c4_cont, c='qif2', ICP=[5, 19], NDIM=n_dim, NPAR=n_params,
                                 RL0=0.0, RL1=25.0, NMX=20000, DSMAX=0.1, name=f'k_gp/k_pe:hb2', bidirectional=True)
