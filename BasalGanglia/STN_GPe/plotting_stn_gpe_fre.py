...
if c2:
    ...
    ax = a.plot_continuation('PAR(22)', 'PAR(25)', cont=f'{condition}:k_gp:2', ax=ax, default_size=markersize1,
                             line_style_unstable='solid', ignore=['UZ'])
    ...
    ax = a.plot_continuation('PAR(25)', 'U(2)', cont=f'{condition}:k_stn', ax=ax, line_color_stable='#3689c9',
                             line_color_unstable='#3689c9', default_size=markersize1, ignore=['UZ'])
    ax = a.plot_continuation('PAR(25)', 'U(2)', cont=f'{condition}:k_stn:lc1', ax=ax, line_color_stable='#148F77',
                             line_color_unstable='#148F77', default_size=markersize1, ignore=['UZ', 'BP'])
    ax = a.plot_continuation('PAR(25)', 'U(2)', cont=f'{condition}:k_stn:lc2', ax=ax, line_color_stable='#148F77',
                             line_color_unstable='#148F77', default_size=markersize1, ignore=['UZ', 'BP'])
    ...
    ax = a.plot_continuation('PAR(22)', 'U(2)', cont=f'{condition}:k_gp', ax=ax, line_color_stable='#3689c9',
                             line_color_unstable='#3689c9', default_size=markersize1, ignore=['UZ'])
    ax = a.plot_continuation('PAR(22)', 'U(2)', cont=f'{condition}:k_gp:lc1', ax=ax, line_color_stable='#148F77',
                             line_color_unstable='#148F77', default_size=markersize1, ignore=['UZ', 'BP'])
    ax.set_xlabel(r'$k_{gp}$')
    #ax.set_ylabel(r'Firing rate (GPe-p)')
    ...
    ax = a.plot_continuation('PAR(22)', 'U(2)', cont=f'{condition}:k_gp:2', ax=ax, line_color_stable='#3689c9',
                             line_color_unstable='#3689c9', default_size=markersize1, ignore=['UZ'])
    ax = a.plot_continuation('PAR(22)', 'U(2)', cont=f'{condition}:k_gp:2:lc1', ax=ax, line_color_stable='#148F77',
                             line_color_unstable='#148F77', default_size=markersize1, ignore=['UZ', 'BP'])
    #ax.set_ylabel(r'Firing rate (GPe-p)')
