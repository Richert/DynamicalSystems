	...
	double precision eta_a,tau_a,delta_a,gpe_p_1,tau_e
	...
	double precision k_e_d,k_ei_d,k_i_d,k_a_d
	...
	delta_e = delta_e*tau_e*tau_e*d
	delta_i = delta_i*tau_i*tau_i/(d*d)
	...
	k_ai = k_ai*sqrt(delta_a)
	k_aa = k_aa*sqrt(delta_a)
	...
	double precision tau_e,tau_i,tau_a
