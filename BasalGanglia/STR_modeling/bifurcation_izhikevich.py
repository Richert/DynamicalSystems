...
a.run(starting_point='HB1', c='qif2', ICP=[7, 16], name='C/I:hb1', origin=f'I:{target+1}', NMX=8000, DSMAX=0.05,
      NPR=50, RL1=100.0, RL0=1.0, bidirectional=True)
a.run(starting_point='LP1', c='qif2', ICP=[7, 16], name='C/I:lp1', origin=f'I:{target+1}', NMX=8000, DSMAX=0.05,
      NPR=50, RL1=100.0, RL0=1.0, bidirectional=True)
a.run(starting_point='LP2', c='qif2', ICP=[7, 16], name='C/I:lp2', origin=f'I:{target+1}', NMX=8000, DSMAX=0.05,
      NPR=50, RL1=100.0, RL0=1.0, bidirectional=True)
