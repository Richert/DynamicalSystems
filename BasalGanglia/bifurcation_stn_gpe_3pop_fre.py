...
c4_sols, c4_cont = a.run(starting_point=starting_point, origin=starting_cont, c='qif', ICP=5, NDIM=n_dim,
                         NPAR=n_params, RL1=20.0, NMX=4000, DSMAX=0.05, name=f'k_pe:tmp',
                         UZR={5: [8.0, 18.0]})
...
# a.run(starting_point='HB1', origin=c5_cont, c='qif2b', ICP=[19, 11], NDIM=n_dim, NPAR=n_params, RL0=0.0, RL1=9.0,
...
# a.run(starting_point='HB1', origin=c6_cont, c='qif2b', ICP=[19, 11], NDIM=n_dim, NPAR=n_params, RL0=10.0, RL1=15.0,
...
c7_2d1_sols, c7_2d1_cont = a.run(starting_point='LP1', origin=c7_cont, c='qif2', ICP=[5, 19], NDIM=n_dim, NPAR=n_params,
                                 RL0=0.0, RL1=20.0, NMX=20000, DSMAX=0.1, name=f'k_gp/k_pe:lp1', bidirectional=True)
c7_2d2_sols, c7_2d2_cont = a.run(starting_point='LP2', origin=c7_cont, c='qif2', ICP=[5, 19], NDIM=n_dim, NPAR=n_params,
                                 RL0=0.0, RL1=20.0, NMX=20000, DSMAX=0.1, name=f'k_gp/k_pe:lp2', bidirectional=True)
