...
c2_b8_sols, c2_b8_cont = a.run(starting_point='UZ2', origin=c2_b5_2d2_cont, c='qif', ICP=25, NDIM=n_dim,
                               NPAR=n_params, RL0=0.35, RL1=0.45, NMX=4000, DSMAX=0.1, name=f'k_stn:tmp',
                               bidirectional=True)
c2_b8_2d1_sols, c2_b8_2d1_cont = a.run(starting_point='HB1', origin=c2_b8_cont, c='qif2', ICP=[25, 22], NDIM=n_dim,
                                       NPAR=n_params, RL0=0.0, RL1=6.0, NMX=10000, DSMAX=0.1,
                                       name=f'k_gp/k_stn:hb3', bidirectional=True, UZR={22: 2.7})
c2_b9_sols, c2_b9_cont = a.run(starting_point='UZ1', origin=c2_b8_2d1_cont, c='qif', ICP=25, NDIM=n_dim,
                               NPAR=n_params, RL0=0.01, RL1=0.15, NMX=1000, DSMAX=0.1, name=f'k_stn:tmp',
                               bidirectional=True)
c2_b9_2d1_sols, c2_b9_2d1_cont = a.run(starting_point='LP1', origin=c2_b9_cont, c='qif2', ICP=[25, 22], NDIM=n_dim,
                                       NPAR=n_params, RL0=0.0, RL1=6.0, NMX=10000, DSMAX=0.1,
