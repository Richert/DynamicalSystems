...
c0_sols, c0_cont = a.run(e='stn_gpe_forced', c='qif_lc', ICP=[31,11], NPAR=n_params, name='alpha', NDIM=n_dim,
                         RL0=0.0, RL1=100.0, bidirectional=True, NMX=6000, DSMAX=0.001, STOP={'UZ6'},
                         UZR={31: [0.0025, 0.005, 0.0075, 0.01]})
