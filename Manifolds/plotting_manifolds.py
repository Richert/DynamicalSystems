...
ax2.bar(x1, [m[0] for m in modules_het], yerr=[m[1] for m in modules_het], color='grey', width=0.4)
ax2.bar(x2, [m[0] for m in modules_hom], yerr=[m[1] for m in modules_hom], color='blue', width=0.4)
