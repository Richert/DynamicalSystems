...
a.run(starting_point='UZ1', c='qif', ICP=8, NPAR=n_params, NDIM=n_dim, name='eta:1',
      origin='t', NMX=10000, DSMAX=0.05, UZR={8: [50.0]}, STOP=[], NPR=NPR, RL1=100.0, RL0=-100.0)

# continuation in global coupling strength
a.run(starting_point='UZ1', c='qif', ICP=4, NPAR=n_params, NDIM=n_dim, name='g:1',
      origin='eta:1', NMX=8000, DSMAX=0.05, UZR={4: [80.0]}, STOP=[], NPR=NPR, RL1=100.0, RL0=0.0,
      bidirectional=True)
...
a.run(starting_point='LP1', c='qif2', ICP=[4, 19], name='g/d:lp1', origin=f'd:1', NMX=8000, DSMAX=0.1,
      NPR=NPR, RL1=100.0, RL0=0.0, bidirectional=True)
a.run(starting_point='LP2', c='qif2', ICP=[4, 19], name='g/d:lp2', origin=f'd:1', NMX=8000, DSMAX=0.1,
      NPR=NPR, RL1=100.0, RL0=0.0, bidirectional=True)
a.run(starting_point='HB1', c='qif2', ICP=[4, 19], name='g/d:hb1', origin=f'd:1', NMX=8000, DSMAX=0.1,
      NPR=NPR, RL1=100.0, RL0=0.0, bidirectional=True)
