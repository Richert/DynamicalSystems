...
im = ax.imshow(test_score_mean[:, :], aspect=1.0)
ax.set_ylabel(p1)
...
im = ax.imshow(train_score_mean[:, :], aspect=1.0)
ax.set_ylabel(p1)
ax.set_yticks(np.arange(len(p1_vals)), labels=p1_vals)
ax.set_xlabel(p2)
ax.set_xticks(np.arange(len(p2_vals)), labels=p2_vals)
...
im = ax.imshow(dim_mean[:, :], aspect=1.0)
ax.set_ylabel(p1)
ax.set_yticks(np.arange(len(p1_vals)), labels=p1_vals)
ax.set_xlabel(p2)
ax.set_xticks(np.arange(len(p2_vals)), labels=p2_vals)
...
im = ax.imshow(kernel_diff_mean[:, :], aspect=1.0)
ax.set_ylabel(p1)
ax.set_yticks(np.arange(len(p1_vals)), labels=p1_vals)
ax.set_xlabel(p2)
ax.set_xticks(np.arange(len(p2_vals)), labels=p2_vals)
...
# ax.plot(test_score_mean[:, :].flatten(), dim_mean[:, :].flatten(), "*-")
# ax.set_xlabel("score")
# ax.set_ylabel("dim")
...
# ax.plot(test_score_mean[:, :].flatten(), kernel_diff_mean[:, :].flatten(), "*-")
# ax.set_xlabel("score")
# ax.set_ylabel("diff")
